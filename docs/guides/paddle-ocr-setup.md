...
Use [MAA OCR adoption](../reference/maa-ocr-adoption.md) for the active MAAFramework OCR policy and [GLM-OCR optional verification setup](glm-ocr-setup.md) for local GLM verification.
