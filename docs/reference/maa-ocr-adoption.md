...
- The Suki/Avalonia UI, HTTP API, candidate-review workflow, and overlay state model remain RHODES OBS COMMANDER3373 code.
- OCR engine invocation is owned by MAAFramework Resource tasks in the Suki/Avalonia app. GLM-OCR is available only as an optional verification engine.
